...
# Download drivers for lenovo-thinkpad-p1-gen5
# Run directly on pc-deploy as SYSTEM (Scheduled Task)
# Progress logged to C:\deploy\drivers\lenovo-thinkpad-p1-gen5\_download.log

$DriverRoot    = "C:\deploy\drivers\lenovo-thinkpad-p1-gen5"
$ManifestPath  = "C:\deploy\scripts\21g2-driver-manifest.json"
...
Write-Log "=== Starting driver download: lenovo-thinkpad-p1-gen5 ==="
...
Write-Log "=== Download complete: lenovo-thinkpad-p1-gen5 ==="
