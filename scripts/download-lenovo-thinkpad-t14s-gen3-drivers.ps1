...
# Download drivers for lenovo-thinkpad-t14s-gen3
# Run directly on pc-deploy as SYSTEM (Scheduled Task)
# Progress logged to C:\deploy\drivers\lenovo-thinkpad-t14s-gen3\_download.log

$DriverRoot    = "C:\deploy\drivers\lenovo-thinkpad-t14s-gen3"
$ManifestPath  = "C:\deploy\scripts\21dc-driver-manifest.json"
...
Write-Log "=== Starting driver download: lenovo-thinkpad-t14s-gen3 ==="
...
Write-Log "=== Download complete: lenovo-thinkpad-t14s-gen3 ==="
