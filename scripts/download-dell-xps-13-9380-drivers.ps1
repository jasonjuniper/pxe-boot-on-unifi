...
# Download drivers for dell-xps-13-9380
# Run directly on pc-deploy as SYSTEM (Scheduled Task)
# Progress logged to C:\deploy\drivers\dell-xps-13-9380\_download.log

$DriverRoot    = "C:\deploy\drivers\dell-xps-13-9380"
$ManifestPath  = "C:\deploy\scripts\xps9380-driver-manifest.json"
...
Write-Log "=== Starting driver download: dell-xps-13-9380 ==="
...
Write-Log "=== Download complete: dell-xps-13-9380 ==="
