...
# Download drivers for lenovo-ideapad-flex5
# Run directly on pc-deploy as SYSTEM (Scheduled Task)
# Progress logged to C:\deploy\drivers\lenovo-ideapad-flex5\_download.log

$DriverRoot    = "C:\deploy\drivers\lenovo-ideapad-flex5"
$ManifestPath  = "C:\deploy\scripts\82yn-driver-manifest.json"
...
Write-Log "=== Starting driver download: lenovo-ideapad-flex5 ==="
...
Write-Log "=== Download complete: lenovo-ideapad-flex5 ==="
